...
class MyTopology(Topo): 
    ...
    def __init__(self): 
        ...
        s0 = self.addSwitch(name='s0', protocols='OpenFlow13')
        s1 = self.addSwitch(name='s1', protocols='OpenFlow13')
        s2 = self.addSwitch(name='s2', protocols='OpenFlow13')
        s4 = self.addSwitch(name='s4', protocols='OpenFlow13')
        s5 = self.addSwitch(name='s5', protocols='OpenFlow13')
        h3 = self.addHost(name='h3', ip='1.2.3.1\16')
        s6 = self.addSwitch(name='s6', protocols='OpenFlow13')
        ...
        s10 = self.addSwitch(name='s10', protocols='OpenFlow13')
